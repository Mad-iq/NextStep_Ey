    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Premium Job Board</h3>
            <p className="text-gray-400">Find your dream job with our AI-powered job matching system.</p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; 2023 Premium Job Board. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
